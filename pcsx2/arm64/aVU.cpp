...
// DebugTools was stripped from the libretro fork; the MVU_DIFF shadow tool
// only uses its VU micro disassembler for log readability -- stub it with the
// raw opcode words instead.
#include "common/StringUtil.h"
static inline std::string disVU1MicroUF(u32 code, u32 /*pc*/) { return StringUtil::StdStringFromFormat("U:%08x", code); }
static inline std::string disVU1MicroLF(u32 code, u32 /*pc*/) { return StringUtil::StdStringFromFormat("L:%08x", code); }
