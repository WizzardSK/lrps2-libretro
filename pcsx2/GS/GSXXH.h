...
static __forceinline u64 GSXXH3_64bits(const void* data, size_t len)
{
...
static __forceinline XXH_errorcode GSXXH3_64bits_update(XXH3_state_t* state, const void* input, size_t len)
{
...
static __forceinline u64 GSXXH3_64bits_digest(XXH3_state_t* state)
{
