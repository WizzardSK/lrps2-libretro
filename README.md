...
Overall recompiler-suite progress: roughly **~69 %** (weighted by remaining
...
| IOP (R3000A) JIT | 85 % | Native ALU, aligned loads/stores, branches + delay slots, block linking, write-back GPR register cache (w22–w27, `LRPS2_NO_IOP_REGCACHE=1` to disable); mult/div/COP0/unaligned via interpreter |
