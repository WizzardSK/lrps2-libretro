...
| MTVU (VU1 thread) | **Experimental, default off** — enable with `LRPS2_MTVU=1`. Verified pixel-identical on MMX7; GT3 currently regresses to black with it on |
...
| `LRPS2_MTVU=1` | Enable the experimental MTVU worker thread |
