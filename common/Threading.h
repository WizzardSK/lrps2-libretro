...
namespace Threading
{
	...
	public:
		...
		void SetStackSize(u32 size) { m_stack_size = size; }
	...
	class WorkSema
	{
		...
		{
			s32 waiting_empty_cleared = current & (STATE_FLAG_WAITING_EMPTY - 1);
			s32 new_state = (waiting_empty_cleared == STATE_RUNNING_0) ? STATE_SLEEPING : STATE_RUNNING_0;
